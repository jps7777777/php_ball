...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIEl7kVAmyHsOU"; // AccessKeyId

        $accessKeySecret = "tHfwEG0wSzrKV8GqDxiOE7zD6SOUCg"; // AccessKeySecret
    ...
    public static function sendSms($mobile, $code) {
        ...
        $request->setSignName("百汇集");
        // $request->setSignName("叠金球");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_142389790");
